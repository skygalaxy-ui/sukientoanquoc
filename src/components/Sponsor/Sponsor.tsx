...
export default function Sponsor({ images }: { images?: Record<string, string> }) {
    return (
                ...
                <div className={styles.contactBox}>
                    <div className={styles.contactItem}>
                        ...
                        <div>
                            ...
                            <a href="tel:0857999545" className={styles.contactValue}>0857 999 545</a>
                        </div>
                    </div>
                    ...
                    <a href="tel:0857999545" className={styles.bigCta}>
