...
function getProjects(images?: Record<string, string>) {
    return [
        ...
        { slug: 'sports-day-noi-bo', title: 'SPORTS DAY NỘI BỘ', client: 'Samsung Electronics — 800 người', image: images?.portfolio_4 || 'https://images.unsplash.com/photo-1461896836934-bd45ea8ba7cd?w=600&q=80&fm=webp', tag: 'SPORTS DAY', color: '#F97316' },
