...
export const metadata: Metadata = {
    title: "Tin Tức — Kiến thức Sự kiện & Teambuilding",
    description:
        "Tin tức, kiến thức tổ chức sự kiện, teambuilding, company trip, year end party. Cập nhật xu hướng event mới nhất từ Sự Kiện Toàn Quốc.",
    alternates: {
        canonical: "https://sukientoanquoc.com/tin-tuc",
    },
    openGraph: {
        title: "Tin Tức — Sự Kiện Toàn Quốc",
