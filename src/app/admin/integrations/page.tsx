    ...
    return (
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className={`rounded-2xl border p-5 ${settings.ga4_enabled && isGA4Valid ? 'bg-orange-50 border-orange-200' : 'bg-gray-50 border-gray-200'}`}>
                    <div className="flex items-center justify-between mb-3">
                        <div className="flex items-center gap-3">
                            <div className={`w-10 h-10 rounded-xl flex items-center justify-center ${settings.ga4_enabled && isGA4Valid ? 'bg-orange-100' : 'bg-gray-200'}`}>
                                <BarChart3 size={20} className={settings.ga4_enabled && isGA4Valid ? 'text-orange-600' : 'text-gray-400'} />
                            </div>
                            <div>
                    ...
                    <p className={`text-xs font-medium ${settings.ga4_enabled && isGA4Valid ? 'text-orange-700' : 'text-gray-400'}`}>
                        {settings.ga4_enabled && isGA4Valid ? `Đã kết nối: ${settings.ga4_measurement_id}` : 'Chưa kết nối'}
                    </p>
                </div>

                <div className={`rounded-2xl border p-5 ${settings.gsc_enabled && isGSCValid ? 'bg-orange-50 border-orange-200' : 'bg-gray-50 border-gray-200'}`}>
                    <div className="flex items-center justify-between mb-3">
                        <div className="flex items-center gap-3">
                            <div className={`w-10 h-10 rounded-xl flex items-center justify-center ${settings.gsc_enabled && isGSCValid ? 'bg-orange-100' : 'bg-gray-200'}`}>
                                <Search size={20} className={settings.gsc_enabled && isGSCValid ? 'text-orange-600' : 'text-gray-400'} />
                            </div>
                            <div>
                    ...
                    <p className={`text-xs font-medium ${settings.gsc_enabled && isGSCValid ? 'text-orange-700' : 'text-gray-400'}`}>
                ...
                <div className="p-6 space-y-5">
                    <div className="bg-gray-50 border border-gray-200 rounded-xl p-4 flex items-start gap-3">
                        ...
                        <div className="text-xs text-gray-600 space-y-1">
                            ...
                            <ol className="list-decimal ml-4 space-y-0.5">
                                ...
                                <li>Copy <strong>Measurement ID</strong> (bắt đầu bằng <code className="bg-gray-200 px-1 rounded">G-</code>)</li>
                            </ol>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div className="relative">
                            ...
                            />
                            {isGA4Valid && (
                                <CheckCircle2 size={16} className="absolute right-3 top-1/2 -translate-y-1/2 text-orange-500" />
                            )}
                        </div>
                                ...
                                <div>
                                    <div className="flex items-center justify-between mb-2">
                                        ...
                                        <button onClick={() => copySnippet(ga4Snippet)}
                                            ...
                                            {copiedSnippet ? <Check size={12} className="text-orange-500" /> : <Copy size={12} />}
                ...
                <div className="p-6 space-y-5">
                    <div className="bg-gray-50 border border-gray-200 rounded-xl p-4 flex items-start gap-3">
                        ...
                        <div className="text-xs text-gray-600 space-y-1">
                            ...
                            <ol className="list-decimal ml-4 space-y-0.5">
                                ...
                                <li>Copy chuỗi <code className="bg-gray-200 px-1 rounded">content=&quot;...&quot;</code> trong meta tag</li>
                    ...
                    <div>
                        ...
                        <input type="text" value={settings.gsc_verification_code}
                            ...
                            className={`w-full px-4 py-3 border rounded-xl text-sm font-mono focus:outline-none focus:ring-2 transition-all ${isGSCValid ? 'border-orange-300 focus:ring-orange-500/20' : 'border-gray-200 focus:ring-gray-900/10'
                                }`}
                        />
                    </div>
            ...
            <div className="bg-gray-50 rounded-2xl border border-gray-200 p-5">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-2">
                    {[
                        { label: 'Google Analytics', url: 'https://analytics.google.com', icon: <BarChart3 size={14} />, color: 'text-gray-700 bg-gray-50 border-gray-200' },
                        { label: 'Search Console', url: 'https://search.google.com/search-console', icon: <Search size={14} />, color: 'text-gray-700 bg-gray-50 border-gray-200' },
                        { label: 'PageSpeed Insights', url: `https://pagespeed.web.dev/analysis?url=${encodeURIComponent(settings.gsc_property_url || '')}`, icon: <Globe size={14} />, color: 'text-gray-700 bg-gray-50 border-gray-200' },
                        { label: 'Rich Results Test', url: 'https://search.google.com/test/rich-results', icon: <CheckCircle2 size={14} />, color: 'text-gray-700 bg-gray-50 border-gray-200' },
                    ].map((link, idx) => (
